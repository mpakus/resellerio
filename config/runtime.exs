...
#
#     PHX_SERVER=true bin/reseller start
#
...
dotenv!(
  ...
  test: ".env.test",
  overwrite: [
    dev: [".env.local", ".env.dev.local"],
    test: ".env.test.local"
  ]
)

storage_base_url =
  System.get_env("TIGRIS_ENDPOINT_URL") || System.get_env("AWS_ENDPOINT_URL_S3") ||
    System.get_env("TIGRIS_BUCKET_URL")

public_base_url =
  System.get_env("TIGRIS_PUBLIC_URL") || System.get_env("TIGRIS_BUCKET_URL")
...
if public_base_url do
  config :reseller, Reseller.Media, public_base_url: public_base_url
end
...
if config_env() == :prod do
  ...
  host = System.get_env("PHX_HOST") || "resellerio.com"
  port = String.to_integer(System.get_env("PORT") || "4000")

  config :reseller, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :reseller, Reseller.Mailer,
